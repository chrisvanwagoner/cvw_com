...
// Work section slides in from the left
// animation object
...
$(window).scroll(function() {
	...
	// console.log("elementDistanceToWindowTop is " + elementDistanceToWindowTop);
	// console.log("elementHeight is " + elementHeight);
	// console.log("viewportHeight is " + viewportHeight);
	// console.log("distanceFromTopOfSite is " + distanceFromTopOfSite);
